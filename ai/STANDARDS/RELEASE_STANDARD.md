...
How Claude Starter Kit decides what a release **is**: who it is for, what it promises
...
release's milestone in https://github.com/dragondad22/claude-starter-kit/issues — never as a label on the item.
