...
> equivalent for your tracker (`https://github.com/dragondad22/claude-starter-kit/issues`).
...
## Preconditions
- Issue tracker access configured (`https://github.com/dragondad22/claude-starter-kit/issues`).
...
## Title Format
Use `KIT-XXX` for the work-item ID (e.g. `RST-006`).
- TESTER: `[TEST][KIT-XXX][Severity] Short summary`
- UAT: `[UAT][KIT-XXX][Severity] Short summary`
- SECURITY REVIEWER: `[SEC][KIT-XXX][Severity] Short summary`
- PERFORMANCE SMOKE: `[PERF][KIT-XXX][Severity] Short summary`
