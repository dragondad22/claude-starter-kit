...
- [ ] Dependency/SCA scan: `N/A (no third-party dependencies)` — no high/critical runtime vulnerabilities
- [ ] CI security gates enabled (see `GitHub Actions (.github/workflows/kit-selftest.yml)`)
...
- [ ] Key signal within threshold: `N/A`
