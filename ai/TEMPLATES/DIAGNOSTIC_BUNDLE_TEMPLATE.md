# Diagnostic Bundle: <KIT-NNN> — <short failure title>
...
## What ran
- Work item: <KIT-NNN or "none — routine gate">
...
## Evidence
Artifacts under `testing-reports/artifacts/<date>_<KIT-NNN>_<feature>_<run>/`
