# Claude Starter Kit Agent Setup

The living orientation doc for working in this repo with Claude Code. Keep it current.

## Overview

Claude Code is the primary AI development tool for Claude Starter Kit. Project context is
...
## CI Quality Gates
GitHub Actions (.github/workflows/kit-selftest.yml)
