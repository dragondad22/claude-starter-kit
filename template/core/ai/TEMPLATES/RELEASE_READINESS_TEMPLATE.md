<!-- Generic template from the Claude starter kit. Copy to docs/releases/RELEASE-<version>.md and fill. Rules: ai/STANDARDS/RELEASE_STANDARD.md -->
# Release readiness — {{PROJECT_NAME}} `<version>`
