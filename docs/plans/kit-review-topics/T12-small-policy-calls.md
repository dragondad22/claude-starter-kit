...
- [ ] **T12.1 — `dragondad22/claude-starter-kit`:** interviewed + registered, used nowhere. Use it (CLAUDE.md / agent-setup identity block?) or cut the interview question.
...
**Decision (2026-07-08):**
- **T12.1** — `dragondad22/claude-starter-kit` cut; repo remote detected from `git remote -v` at runtime when needed (T15 rebuilds the interview anyway).
