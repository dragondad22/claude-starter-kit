...
**Progress:** **35 / 37 decided** (T1–T17 on 2026-07-08; T18–T25 on 2026-07-09; T26–T28 on 2026-07-10 — implemented through v0.7.0; T29–T30 on 2026-07-11, from the life-os trial port-backs — implementation tracked as #92/#93 under epic #90; T31 on 2026-07-20 — impl. unblocked 2026-08-13, now T32's phase 5; **T32 opened 2026-07-20, decided 2026-08-13** — the kit ships a compiled tool (`csk`); T2 partially superseded, T23 amended in mechanism, T35 partly folded; T33 Decided 2026-07-28 — independent reviewer agents, grilled from a ShelterSync incident, implemented 2026-07-28→08-03 (#145), released in v0.11.0; T34–T35 opened 2026-07-28 as T33 spin-offs — UX design mode (in discussion), encoding policy (machine-consumed half folded into T32 on 2026-08-13; prose half still open); T36 opened *and decided* 2026-08-03 from the epic #172 post-mortem — the kit scaffolds itself, extending T23.3's self-hosting scope from tracking artifacts to the full working apparatus; **T37 opened and decided 2026-08-03 — proposals vs registers, and the decision that closes this register**).

**Open work (updated 2026-08-13):** every topic left in a draft/deferred state has a tracked issue, so nothing incomplete is invisible — ~~**#159** (T32 grill)~~ **closed 2026-08-13 on the decision**, which spawned the `csk` phase epics (see the epic table) and **unblocked #160** (T31, now T32's phase 5) · **#161** (T34 grill) · **#162** (T35 grill, **rescoped** to the prose half after T32.11 folded the machine-consumed half) · ~~**#163** (T17.9–T17.13 template delta)~~ **closed 2026-08-03**, which surfaced **#166** (interview standard doesn't list the spec among an interview's produced artifacts). **T34 and T35 are the only topics still without a decision**, and both are grilling sessions rather than implementation.
...
| [T31](kit-review-topics/T31-unattended-execution-mode.md) | Unattended (AFK) execution mode: coordinator + serial coding agents | Decided (2026-07-20) — **unblocked 2026-08-13**; implementation is T32's phase 5 under epic #160 |
| [T32](kit-review-topics/T32-kit-runtime-evolution.md) | Kit runtime / delivery evolution: templates-only → templates + tooling | **Decided (2026-08-13)** — a compiled kit-owned tool (`csk`), five phased epics; T2 partially superseded, T23 amended, T35 partly folded |
...
| [T35](kit-review-topics/T35-encoding-policy.md) | Encoding policy: markdown-first vs fit-for-purpose formats | Machine-consumed half **folded into T32** (2026-08-13, T32.11); prose half in discussion — grill tracked (#162, rescoped) |
...
| **#160 Unattended (AFK) execution** *(added 2026-08-03)* | — *(**unblocked 2026-08-13**; this is T32's phase 5 — decompose once #247 lands, since the journal is the event log)* | T31, T32.15 |
| **`csk` — the kit's tool** *(added 2026-08-13, four phased epics)* | #246 phase 1 the tool exists (lints retire into a distributed binary) · #247 phase 2 event log substrate · #248 phase 3 scaffold + config-merge + three-way-merge upgrade · #249 phase 4 zero shipped shell (T2 stamp) | T32; phase 5 is #160 |

**Standalone issues** *(added 2026-08-03 — the draft/deferred sweep; updated 2026-08-13)*: ~~**#159** T32 grill~~ *(closed 2026-08-13 on the decision — spawned #246–#249, unblocked #160)* · **#161** T34 grill · **#162** T35 grill *(rescoped to the prose half)* · **#163** T17.9–T17.13 feature-spec template delta *(closed)* · **#166** interview-standard producer seam, surfaced by #163. Grill issues exit on a filled `Decision:` block plus follow-on issues, not on shipped content.
