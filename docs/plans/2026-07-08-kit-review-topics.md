...
- Single home (T11): `DOCUMENTATION_STANDARD.md` new "Audience-first user-facing text" section; `UI_STANDARD.md` §9/§10 and the coding checklist carry one-liners + pointers. No CLAUDE.md line (budget full; the existing documentation-standard breadcrumb covers it).
