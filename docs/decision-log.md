...
# Claude Starter Kit – Decision Log

**Purpose:**
This document captures *decisions*, not discussions. It is the single source of truth
for what has been decided for Claude Starter Kit, why those decisions were made, and what
...
**Scope:** In | Out (delete if not applicable)
