...
| B-002 | **Dependency hygiene** — SCA/vulnerability scanning runs (`N/A (no third-party dependencies)`), and dependency updates have a named owner and cadence | | ☐ | YYYY-MM-DD | |
