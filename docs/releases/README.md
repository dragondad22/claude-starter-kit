...
**Not yet decided (2026-08-12).** The kit is plausibly *both* — contract-versioned for
adopters who scaffold and upgrade, release-versioned as a product — but the **contract
surface** (what actually constitutes breaking an adopter) depends on the delivery shape,
which is #159's to decide. Tracked in **#242**; deferred deliberately, not unasked.
